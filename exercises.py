...
def calculate_dog_years():
    ...
    # Calculate dog years
    if age <= 2:
        dog_years = age * 10  # First two years count as 10 each
    else:
        dog_years = 20 + (age - 2) * 7  # First two years = 20, rest = 7 per year
...
def weather_advice():
    ...
    # Check the combination of cold and raining to give advice
